...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"若依移动端","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!*************************************************!*\
  !*** D:/do_lab/Ceramics_Project_App/pages.json ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 30 */
/*!************************************************!*\
  !*** D:/do_lab/Ceramics_Project_App/config.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = {
  ...
  server: {
    ...
    // WebSocket服务器地址
    get wsUrl() {
      return "ws://".concat(this.host, ":").concat(this.port);
    }
  }
};
...
/* 67 */
/*!******************************************************!*\
  !*** D:/do_lab/Ceramics_Project_App/utils/socket.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var ChatSocket = /*#__PURE__*/function () {
  function ChatSocket(chatId) {
    (0, _classCallCheck2.default)(this, ChatSocket);
    this.chatId = chatId;
  ...
  (0, _createClass2.default)(ChatSocket, [{
    key: "connect",
    value: function connect() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this.socketTask = wx.connectSocket({
          url: "".concat(_config.default.server.wsUrl, "/ws/chat?chatId=").concat(_this.chatId),
          header: {
        ...
        _this.socketTask.onClose(function () {
          ...
          if (_this.closeResolve) {
            _this.closeResolve();
            _this.closeResolve = null;
          }
        });

        // 监听消息接收
        _this.socketTask.onMessage(function (event) {
    ...
    value: function close() {
      var _this3 = this;
      return new Promise(function (resolve) {
        _this3.isManualClose = true; // 设置主动关闭标记
        _this3.closeResolve = resolve; // 存储resolve回调
        if (_this3.socketTask) {
          _this3.socketTask.close();
        } else {
          resolve();
          _this3.closeResolve = null;
        }
        clearTimeout(_this3.reconnectTimer);
        _this3.messageCallbacks = [];
      });
    }
  }]);
  return ChatSocket;
...
/* 68 */
/*!**********************************************************!*\
  !*** D:/do_lab/Ceramics_Project_App/utils/chatSocket.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
    ...
    value: function _connect() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this.socketTask.onError(function (error) {
          ...
          // 执行回调
          if (_this.connectCallback) {
            _this.connectCallback(false, error);
            _this.connectCallback = null;
          }
          reject(error);
        });
        ...
        _this.socketTask.onClose(function () {
          ...
          // 执行回调
          if (_this.connectCallback) {
            _this.connectCallback(false, new Error('连接已关闭'));
            _this.connectCallback = null;
          }
...
/* 100 */
/*!******************************************************************************************************!*\
  !*** D:/do_lab/Ceramics_Project_App/uni_modules/uni-icons/components/uni-icons/uniicons_file_vue.js ***!
  \******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
