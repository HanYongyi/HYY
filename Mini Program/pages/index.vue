		...
		<view class="home-page">
			...
			<view class="daily-report">
				<view class="report-header">
					<text class="header-title">精选日报</text>
					<view class="date-wrap">
						<text class="date-text">{{ currentDate }}</text>
						<uni-icon type="calendar" size="28rpx" color="#8f8f94" class="date-icon"></uni-icon>
					</view>
				</view>
				<view class="report-list">
					<view class="list-item" v-for="(item, idx) in reportList" :key="idx">
						<view class="item-number">{{ idx + 1 }}</view>
